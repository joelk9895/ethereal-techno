...
const YouTubeMusicIcon = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm0-12.5c-2.48 0-4.5 2.02-4.5 4.5s2.02 4.5 4.5 4.5 4.5-2.02 4.5-4.5-2.02-4.5-4.5-4.5zm-2 6.5V9l4 2.5-4 2.5z" />
    </svg>
);
                            ...
                            <div className="flex flex-wrap items-center gap-3">
                                {[
                                    ...
                                    { 
                                        ...
                                        icon: profile?.youtube?.includes('music.youtube.com') ? YouTubeMusicIcon : Youtube, 
                                        label: profile?.youtube?.includes('music.youtube.com') ? "YouTube Music" : "YouTube" 
                                    },
...
const SoundCloudEmbed = ({ url }: { url: string }) => {
    ...
    // Strip query params and extract clean track name
    ...
    return (
        <div className="group space-y-3">
            ...
            <div className="px-1">
                <p className="text-white/70 text-xs font-sans font-medium line-clamp-2 leading-snug tracking-wide capitalize">
                    {trackName}
                </p>
            </div>
        </div>
