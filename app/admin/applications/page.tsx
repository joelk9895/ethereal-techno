...
const ApplicationRow: React.FC<ApplicationRowProps> = ({ app, router }) => {
    ...
    return (
        <motion.div
            ...
            className="group grid grid-cols-1 md:grid-cols-12 gap-4 px-8 py-6 bg-zinc-900/40 border border-white/5 hover:border-primary/40 hover:bg-white/[0.02] transition-colors cursor-pointer items-center rounded-[2rem]"
        >
            {/* Identity */}
